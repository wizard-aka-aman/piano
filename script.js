...
document.addEventListener("keydown" , ({keyCode}) =>{
  ...
  if(keyCode == 38){
    setInterval(playA4,500);
    setInterval(playC5,3000);
    setInterval(playD5,2000);
    setInterval(playE5,500);
    setInterval(playA4,700);
    setInterval(playB4,900);
    setInterval(playC5,500);
    setInterval(playD5,800);
    setInterval(playE5,500);
    // setInterval(playB4,4000);
    // setInterval(playC4,10000);
    // setInterval(playD4,9000);
    // setInterval(playE4,8000);
    // setInterval(playF4,7000);
    // setInterval(playG4,6000);
    // setInterval(playC4,6000);
    // setInterval(playD4,5000);
    // setInterval(playE4,9000);
    // setInterval(playF4,4000);
    // setInterval(playG4,3000);
  }
});
